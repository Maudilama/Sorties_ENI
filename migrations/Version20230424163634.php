 ...
 */
final class Version20230424163634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD lieu_id INT DEFAULT NULL, ADD etat_id INT DEFAULT NULL, ADD campus_id INT DEFAULT NULL, ADD organisateur_id INT DEFAULT NULL');
